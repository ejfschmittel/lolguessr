...
import ChampionsInput from "../components/ChampionInputBox"
import {getRandomChampionAbillity, getImageUrl} from "../utils/riot"


import "../styles/pages/GuessChampionByAbilityGame.styles.scss";
/*
        ...
        <div>
            <div>
                ...
                <div className="buttons">
                    <button className="button button--default" onClick={onHintPress}>Hint</button>
                    <button className="button button--default" onClick={onSolvePress}>Solve</button>
